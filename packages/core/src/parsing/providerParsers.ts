...
function parseOpenCodePayload(args: ParseProviderPayloadArgs): ParsedProviderMessage[] {
...
function nativeDurationSegment(durationMs: number | null): {
  operationDurationMs?: number | null;
  operationDurationSource?: OperationDurationSource | null;
  operationDurationConfidence?: OperationDurationConfidence | null;
} {
...
function extractOpenCodeCreatedAt(
  ...
  return (
    ...
    extractEventTimestamp(messageData) ??
    EPOCH_ISO
  );
}
